...
```bash
/usr/local/bin/opscli task -f tasks/file-download.yaml --fileapi https://gh-upload.chenshaowen.com/api/v1/files --aeskey <AES_KEY> --remotefile <URL> --localfile dockerfile1
```
